            ...
            >
              ...
              <div className="max-w-2xl mx-auto mb-8">
                ...
                >
                  ...
                  <p className="font-mono text-xs text-bone/80 leading-relaxed text-center">
                    ...
                    <br/><span className="text-bunker">Never mentioned in the prompt. Yet unmistakably her.</span>
                  </p>
                </motion.div>
              ...
              >
                <p className="font-mono text-[11px] text-bone/70 leading-relaxed">
                  Why did "transformation" and "eternity" become <span className="text-prismatic">her face</span>?
                </p>
              </motion.div>
            </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="font-mono text-xs text-bunker/70 mb-4 leading-relaxed">
                      Watch video clips generated by Google Nano Banana Pro from <span className="text-flare">abstract concepts alone</span>. 
            ...
            <div className="p-4 border-b border-bunker/20 relative z-20">
              ...
              <div className="text-center max-w-2xl mx-auto">
                <p className="font-mono text-xs text-bone/70 mb-2">
                  Video clips generated by <span className="text-flare">P.Lazniak's AI agent based on Gemini</span> 
